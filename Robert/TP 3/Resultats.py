...
Hpi = 1500#input("Entrer l'hauteur initiale (ft) : ")
Hpf = 41000#input("Entrer l'hauteur finale (ft) : ")
...
VKCAS = 275#input("Entrer la valeur du VKCAS (kts) : ")
VWIND = 20#input("Entrer la valeur du VWIND (kts) : ")
Mach = 0.74#input("Entrer la valeur du nombre de Mach (-) : ")
Wi = 52800#input("Entrer la valeur de la masse initiale (lbs) : ")
ISA = 10#input("Entrer la valeur de la déviation par rapport à ISA (C) : ")

regime = 'MCL'#input("Entrer le choix du régime (MCR, MTO, GA, Idle, MCT, MCL ou Poussee_totale) : ")
...
no_moteurs = 'AEO' #input("Entrer le nombre de moteurs (AEO, OEI) - Mettre n'importe lequel si vous avez choisi Poussee_totale : ")
