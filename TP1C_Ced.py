...
print("Est-il possible que la vitesse vraie (TAS) soit égale à sa vitesse CAS ? Si oui, sous quelle(s) condition(s)? \n")
...
idx=-1
altitudes = np.linspace(0, 65000, 32500)
Mach = []
...
plt.plot(CAS, temps, color='blue')
plt.title("CAS en fonction de la température totale.")
plt.xlabel('CAS (kts)')
plt.grid()
if idx!=-1:
